...
from test1.test1Impl import test1
from test1.test1Server import MethodContext
from test1.authclient import KBaseAuth as _KBaseAuth
...
class test1Test(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        for nameval in config.items('test1'):
